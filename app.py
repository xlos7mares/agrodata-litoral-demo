...
st.markdown("""
    ...
    /* Recuadro de Informe (Limpio y Profesional) */
    .informe-premium {
...
# 2. BARRA LATERAL (CONTROL Y SIMULADOR)
with st.sidebar:
...
# 3. ENCABEZADO: LOGO Y PERFIL COMPLETO (RESTAURADO)
with st.container():
    col_l, col_r = st.columns([2.5, 3.5])
    with col_l:
        st.markdown("<div style='display: flex; align-items: center; margin-top: 10px;'><span style='font-size: 85px; margin-right: 20px;'>🛰️</span><div style='font-family: \"Arial Black\"; font-size: 35px; line-height: 0.9; color: white;'>AGRO<span style='color:#39FF14;'>DATA</span><br>LITORAL</div></div>", unsafe_allow_html=True)
    with col_r:
...
# 5. INFORME PROFESIONAL (ESTRUCTURA BLINDADA)
...
<div class="informe-premium">
    ...
    <p><b>🌍 Para Geólogos:</b> Los {s_suelo} MPa obtenidos mediante sensores térmicos de NASA Landsat confirman un suelo {msg_suelo}. La humedad de {s_agua}% en la zona radicular valida la estabilidad del terreno.</p>
    ...
    <div style="background:#e8f5e9; padding:20px; border-radius:10px; border:1px solid #1e4d2b; margin-top:15px;">
        ...
        <p style="font-size:14px; margin-top:10px;">Google Earth son fotos históricas. AgroData es una <b>Auditoría en Tiempo Real</b>. Cruzamos coordenadas de Catastro con datos NASA. Usted no paga por un dibujo, paga por seguridad física de su tierra.</p>
    </div>
